...
namespace LocalIdentity.SimpleInfra.Infrastructure.Caching.Brokers;
...
) : ICacheBroker
{
    ...
    public ValueTask DeleteAsync<T>(string key, CancellationToken cancellationToken = default)
    {
