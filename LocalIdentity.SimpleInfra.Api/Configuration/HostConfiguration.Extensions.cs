...
using LocalIdentity.SimpleInfra.Infrastructure.Caching.Brokers;
using LocalIdentity.SimpleInfra.Infrastructure.EventBus.Brokers;
using LocalIdentity.SimpleInfra.Infrastructure.EventBus.Services;
using LocalIdentity.SimpleInfra.Infrastructure.Identity.Services;
using LocalIdentity.SimpleInfra.Infrastructure.Notifications.Brokers;
using LocalIdentity.SimpleInfra.Infrastructure.Notifications.EventSubscriber;
using LocalIdentity.SimpleInfra.Infrastructure.Notifications.Services;
using LocalIdentity.SimpleInfra.Infrastructure.Serializers;
using LocalIdentity.SimpleInfra.Infrastructure.Settings;
using LocalIdentity.SimpleInfra.Infrastructure.Verifications.Services;
...
namespace LocalIdentity.SimpleInfra.Api.Configuration;
